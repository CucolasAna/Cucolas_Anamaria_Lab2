...
{
    public class BookCategoriesPageModelcs: PageModel
    {
        
 
 public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Cucolas_Anamaria_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Cucolas_Anamaria_Lab2Context context,
